...
The ``embedding_with_htsne`` tutorial additionally showcases the new hvis
``goals`` (guided layout via ``LabelCohesion``) and ``embedding_health``
(trustworthiness/continuity receipt).
