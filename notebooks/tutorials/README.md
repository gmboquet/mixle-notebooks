...
| [fitting_and_estimation](fitting_and_estimation.ipynb) | The fitting entry points: `optimize`/`best_of`/`iterate` (EM), `fit_mle`/`fit_map` (gradient + MAP), the EM-strategy zoo, and custom objectives. |
